...
QDRANT_HTTP_LOCAL_PORT="${QDRANT_HTTP_LOCAL_PORT:-6333}"
QDRANT_HTTP_REMOTE_HOST="${QDRANT_HTTP_REMOTE_HOST:-127.0.0.1}"
QDRANT_HTTP_REMOTE_PORT="${QDRANT_HTTP_REMOTE_PORT:-6333}"
QDRANT_GRPC_LOCAL_PORT="${QDRANT_GRPC_LOCAL_PORT:-6334}"
QDRANT_GRPC_REMOTE_HOST="${QDRANT_GRPC_REMOTE_HOST:-127.0.0.1}"
QDRANT_GRPC_REMOTE_PORT="${QDRANT_GRPC_REMOTE_PORT:-6334}"
...
echo "  Qdrant:    HTTP 127.0.0.1:${QDRANT_HTTP_LOCAL_PORT}, gRPC 127.0.0.1:${QDRANT_GRPC_LOCAL_PORT}"
...
exec "${SSH_COMMAND[@]}" \
  ...
  -L "${QDRANT_HTTP_LOCAL_PORT}:${QDRANT_HTTP_REMOTE_HOST}:${QDRANT_HTTP_REMOTE_PORT}" \
  -L "${QDRANT_GRPC_LOCAL_PORT}:${QDRANT_GRPC_REMOTE_HOST}:${QDRANT_GRPC_REMOTE_PORT}" \
  "${SSH_TUNNEL_TARGET}"
