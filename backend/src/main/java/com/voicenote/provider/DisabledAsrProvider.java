...
public class DisabledAsrProvider implements AsrProvider {
    @Override public AsrSubmission submit(AudioBlob audio) { throw new ProviderException(ProviderException.Kind.FINAL_REJECTION, "ASR_PROVIDER_DISABLED", "DashScope is disabled; configure DASHSCOPE_ENABLED and DASHSCOPE_API_KEY"); }
