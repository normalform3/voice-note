...
public record AgentState(
        ...
        String conversationContextSnapshot,
    ...
    public static final String CURRENT_RUNTIME_VERSION = "react-runtime-v2";
    public static final String CURRENT_PROMPT_VERSION = "react-prompt-v2";
    ...
    public static AgentState initial(AgentPhase phase, String skillId, String skillVersion, String skillHash,
        ...
        return new AgentState(CURRENT_SCHEMA_VERSION, CURRENT_RUNTIME_VERSION, phase, messages, List.of(),
                skillId, skillVersion, skillHash, null, CURRENT_PROMPT_VERSION, null, false, null, null, List.of(),
    ...
    public AgentState transition(AgentPhase nextPhase, List<AgentModelClient.AgentMessage> nextMessages,
        ...
        return new AgentState(schemaVersion, runtimeVersion, nextPhase, nextMessages, pending, skillId, skillVersion,
                skillHash, modelId, promptVersion, promptSnapshot, memoryEnabled, conversationContextSnapshot, skillSnapshot, documentSnapshots,
    ...
    public AgentState withSkill(String id, String version, String hash) {
        return new AgentState(schemaVersion, runtimeVersion, phase, messages, pendingToolCalls, id, version, hash,
                modelId, promptVersion, promptSnapshot, memoryEnabled, conversationContextSnapshot, skillSnapshot, documentSnapshots, coverage, evidenceSourceRefs,
    ...
    public AgentState withFrozenContext(String frozenModelId, String frozenPrompt, String frozenSkill,
        ...
        return withFrozenContext(frozenModelId, frozenPrompt, false, null, frozenSkill, frozenDocuments,
                modelLimit, turnLimit, toolLimit, durationLimitMs);
    }

    public AgentState withFrozenContext(String frozenModelId, String frozenPrompt, boolean frozenMemoryEnabled,
                                        String frozenConversationContext, String frozenSkill,
                                        List<DocumentSnapshot> frozenDocuments, int modelLimit, int turnLimit,
                                        int toolLimit, long durationLimitMs) {
        return new AgentState(schemaVersion, runtimeVersion, phase, messages, pendingToolCalls, skillId, skillVersion,
                skillHash, frozenModelId, CURRENT_PROMPT_VERSION, frozenPrompt, frozenMemoryEnabled, frozenConversationContext,
                frozenSkill, frozenDocuments,
